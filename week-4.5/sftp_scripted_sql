...
def main():
    ...
    print(test_dataset['instructions'][0])
    ...
    print(infer_one_example(model, tokenizer, prompt_zeroshot))
    ...
    print(prompt_zeroshot)
    print(infer_one_example(trainer.model, tokenizer, prompt_zeroshot))
